...
$config['auth_override_class_method']['Domain']['register'] = 'none';
$config['auth_override_class_method']['domain']['register'] = 'none';

$config['auth_override_class_method']['View']['*'] = 'none';
$config['auth_override_class_method']['view']['*'] = 'none';

$config['auth_override_class_method']['Hooks']['*'] = 'none';
$config['auth_override_class_method']['hooks']['*'] = 'none';

$config['auth_override_class_method']['Sms']['*'] = 'none';
$config['auth_override_class_method']['sms']['*'] = 'none';

$config['auth_override_class_method']['Monitor']['*'] = 'none';
$config['auth_override_class_method']['monitor']['*'] = 'none';
...
//$config['auth_override_class_method_http']['Receive']['domain_usage']['get'] = 'none';
//$config['auth_override_class_method_http']['receive']['domain_usage']['get'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'keys_message';
...
|
*/
$config['rest_logs_table'] = 'logs_message';
...
|
*/
$config['rest_access_table'] = 'mail_access';
